...
public class Audio1 extends PApplet
{
    ...
    public void draw()
    {
        ...
        smoothedAmplitude = lerp(smoothedAmplitude, average, 0.1f); //Used to smooth the transitions between sample amplitude
        ...
        switch (mode) {
            ...
            case 4:
                ...
                fill(0);
                rectMode(CENTER);
                rect(width / 2, height / 2, smoothedAmplitude * 4000, smoothedAmplitude * 2000);
        }
